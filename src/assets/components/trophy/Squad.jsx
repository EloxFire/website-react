          ...
          <div className="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 aboutYoyo d-flex flex-column flex-xs-column flex-sm-column flex-md-row flex-lg-row">
            ...
            <div className="d-flex flex-column col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6">
              <div>
                ...
                <p className="p-0 m-0">
                  4L née il y a 31 ans, bolide de mère en fille et en excellent état pour son âge plutôt... avancé ! Elle nous enmène partout au quotidien, et nous enmènera jusqu'à Marrakech sans le moindre pépin ! (On l'éspère du moins).
                </p>
              </div>
              <div className="mt-5">
